...
// //   // Get list of unique astrologers connected to a client
// //   async getConnectedAstrologers(req, res) {
// //     try {
// //       const clientId = req.user._id; // Assuming clientId is obtained from the authentication middleware

// //       // Find all sessions with the client
// //       const sessions = await Session.find({ clientId }).distinct('astrologerId');

// //       // Populate astrologer information
// //       const astrologers = await User.find({ _id: { $in: sessions }, role: 'astrologer' }, 'firstName lastName email profilePic');
